...
export default function HeroForm() {
  ...
  return (
    <form onSubmit={handleSearch} className="space-y-5" suppressHydrationWarning>
      <div>
        <label className="block text-sm text-zinc-600 mb-2">Your Suburb / Area</label>
        <input
          name="suburb"
          required
          className="w-full px-5 py-3.5 border border-zinc-200 rounded-2xl focus:outline-none focus:border-emerald-600 text-base sm:text-lg"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        <div>
          ...
          <select
            name="serviceType"
            className="w-full px-5 py-3.5 border border-zinc-200 rounded-2xl focus:outline-none focus:border-emerald-600 text-base sm:text-lg bg-white"
          >
      ...
      <button
        type="submit"
        className="w-full bg-emerald-700 hover:bg-emerald-800 text-white py-4 sm:py-5 rounded-2xl font-medium text-base sm:text-lg transition mt-2"
      >
